...
function renderNextRace(race) {
    ...
    // Practice/Qualifying sessions in a grid
    ...
    // Race - always full width, prominent
    if (raceSession) {
        html += `
            <div class="mt-2 flex flex-col px-4 py-3 bg-gradient-to-br from-ferrari/20 to-red-900/30 rounded-xl border-2 border-ferrari/40 text-center">
